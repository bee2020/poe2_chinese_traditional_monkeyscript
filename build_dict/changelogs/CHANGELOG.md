...
| **核心词缀 (stats.json)** | **8299** | **8211** | 🔴 **88 条** | 🟢 **已查到: 75 条** / ⚪ 未查到: 13 条 | **99.84%** |
...
| 12 | `rune` | `rune.stat_3353733343` | `When you generate a Frenzy Charge, Allies in your Presence generate that Charge instead` | 无法匹配 |

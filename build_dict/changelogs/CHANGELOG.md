...
| **装备与暗金 (items.json)** | **3890** | **3455** | 🔴 **435 件** | 🟢 **已查到: 435 件** / ⚪ 未查到: 0 件 | **100.00%** |
...
| 2 | `explicit` | `explicit.stat_3937291366` | `#% chance to add a Vaal Beacon Unique Monster to the Map` | 无法匹配 |
